				...
				<div class="config_form">
					<form onSubmit={ this.handleSubmit } class="form">
						...
						<Input type="text" name="age"
							label="age" onChange={ this.handleChange }
							value={ this.state.age }
			                className="input" />
						<Input type="text" name="height" 
							label="height"onChange={ this.handleChange } 
							value={ this.state.height }
			                className="input" />
						<Input type="text" name="weight" 
							label="weight" onChange={ this.handleChange } 
							value={ this.state.weight }
			            	className="input" />
						<div>
							<p>Level of sports</p>
							<Input type="radio" name="levelActive" 
								value="0" label="zero active" 
								onChange={ this.handleChange } />
							<Input type="radio" name="levelActive" 
								value="1" label="3 times a week" 
								onChange={ this.handleChange } />
							<Input type="radio" name="levelActive" 
						...
						<div>
							<p>Desired result</p>
							<Input type="radio" name="desiredResult" 
								value="0" label="slim" 
								onChange={ this.handleChange } />
							<Input type="radio" name="desiredResult" 
								value="1" label="stay at this weight" 
								onChange={ this.handleChange } />
							<Input type="radio" name="desiredResult" 
								value="2" label="to gain weight" 
								onChange={ this.handleChange } />
						</div>
